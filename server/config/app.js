...
//modules for authentitification
...
let individualsRouter = require("../routes/individual");
...
//implement a user authenthciate strategy
...
app.use('/individual-list',individualsRouter);
